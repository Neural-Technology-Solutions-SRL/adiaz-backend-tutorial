...
namespace EnumsAndSwitch
{
    internal class Program
    {
        ...
        {
            List<Todo> myTodosList = new List<Todo>
            {
                ...
                new Todo { Description = "Task 11", EstimatedHours = 6,  Status = Status.NotStarted },
                new Todo { Description = "Task 12", EstimatedHours = 6,  Status = Status.Completed  },
                new Todo { Description = "Task 13", EstimatedHours = 6,  Status = Status.Deleted    },
                new Todo { Description = "Task 14", EstimatedHours = 6,  Status = Status.Completed  }

            };


            PrintAssessment(myTodosList);
            Console.ReadLine();
        }
